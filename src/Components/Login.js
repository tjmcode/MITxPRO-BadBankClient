...
function Login()
{
    ...
    function logIn_Click()
    {
        ...
        if (!checkFields())
        {
            console.log(`Account Login: Failed vaildation, no Account accessed.`);
            return;
        }
        ...
        if (!loginSuccess)
        {
            console.log(`User login failed - Email: ${email}, Password: ${password}`);
        ...
        {
            console.log(`User logged in - Email: ${ctx.CurrentUser}, App Index: ${ctx.UserIndex}`);
        }
